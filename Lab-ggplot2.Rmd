...
Según se puede ver en la siguiente gráfica existe una correlación negativa entre los retrasos y el tiempo de vuelo.
```{r ejercicio-1eb, warning=FALSE}
ggplot(data.frame(flights$air_time,flights$dep_delay),
